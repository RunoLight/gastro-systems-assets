/*! based on tinyDatePicker - v0.9.5 2016-11-15 */
...
!function (a, b) {
    ...
    var i = function () {
        ...
        for (var d in b) {
            var e = b[d];
            if ("events" === d) for (var f = e.length; f--;) c(e[f], e[f]._id || f);
    ...
    function e(a, b, d) {
        var e = b.readValue.call(a, d), f = r(e || t(new Date, !0)), g = d.getAttribute(b.timeFormatAttribute), h = !1,
            i = !1;
    ...
    function i(a, b, c) {
        var d = a.options, e = a.calendar, f = a.datePicker, g = {};
    ...
    function l(a, b) {
        for (var c = a.options, d = b.getAttribute(c.rangeStartAttribute) || b.getAttribute(c.rangeEndAttribute), e = document.querySelectorAll("[" + c.rangeStartAttribute + '="' + d + '"],[' + c.rangeEndAttribute + '="' + d + '"],[name="' + d + '"]'), f = e.length; f--;) if (e[f] && e[f] !== b) return e[f]
    }
